...
const CreateUserForm: React.FC = () => {
  ...
  const handleSubmit = async (values: any) => {
    try {
      ...
      // Redirect ke halaman user management setelah 1.5 detik
      setTimeout(() => {
    ...
    >
      ...
      >
        ...
        >
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  ...
                  { pattern: /^\+?[1-9]\d{1,14}$/, message: 'Format nomor telepon tidak valid' }
                ]}
              >
                <Input 
          ...
          {/* Password Section */}
          <h3 style={{ fontWeight: 600, fontSize: "16px", margin: "24px 0 16px" }}>
            Informasi Akun
          </h3>
