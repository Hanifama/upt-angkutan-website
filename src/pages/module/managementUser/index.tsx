...
const UserManagementPage: React.FC = () => {
    ...
    const handleConfirmAction = async () => {
        ...
        try {
            ...
            messageApi.error(error.message || `Gagal ${actionType === "delete" ? "menghapus" : "mengembalikan"} pengguna!`);
        } finally {
            setDeletingId(null);
    ...
    return (
        <div className="space-y-6">
            ...
            >
                ...
                {/* Active Filters Tags */}
                {(searchText || filterRole !== "Semua Role" || filterStatus !== "Semua Status" || dateRange) && (
